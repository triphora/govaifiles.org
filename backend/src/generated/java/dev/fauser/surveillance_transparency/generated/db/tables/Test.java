...
public class Test extends TableImpl<TestRecord> {
     ...
     */
    public final TableField<TestRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.test.name</code>.
     */
    public final TableField<TestRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(100).nullable(false), this, "");
